...
import 'package:flutter_app/ui/pages/profil/data_pengemudi/data_pengemudi_success.dart';
    ...
    return MultiBlocProvider(
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          '/profile/data-pengemudi-success': (context) =>
              const DataPengemudiSuccess(), // New route
